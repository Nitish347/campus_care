...
for root, dirs, files in os.walk(screens_dir):
    for file in files:
        if file in mapping:
            ...
            # Check if it already has subtitle
            if 'subtitle:' not in content:
                # Need to support both 'appBar: AdminPageHeader(' and 'appBar: const AdminPageHeader('
                # Notice in the prev script we injected 'appBar: AdminPageHeader(\n        showBackButton: true,'
